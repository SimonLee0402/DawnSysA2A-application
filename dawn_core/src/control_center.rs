...
<body>
  ...
  <script>
    ...
    const commandTemplates = {
      ...
      browser_profile_import: { sourcePath: "artifacts/browser/imports/ops", profileName: "ops", overwrite: false, approvalRequired: true },
      browser_profile_export: { profileName: "ops", path: "artifacts/browser/profiles/ops", approvalRequired: true },
      ...
      browser_network_export: { sessionId: "browser-default", limit: 100, path: "artifacts/browser/network.json", approvalRequired: true },
      ...
      browser_errors_export: { sessionId: "browser-default", consoleLimit: 100, networkLimit: 100, path: "artifacts/browser/errors.json", approvalRequired: true },
      ...
      system_lock: { approvalRequired: true },
      system_sleep: { approvalRequired: true },
      ...
      desktop_mouse_position: { approvalRequired: true },
      ...
      desktop_screen_info: { approvalRequired: true },
      desktop_snapshot: { windowLimit: 10, includeScreenshot: false, approvalRequired: true },
    ...
    const commandTemplateDescriptions = {
      ...
      browser_profile_import: "Import a saved managed browser profile directory into Dawn's persistent profile store, with optional overwrite when the target profile is idle",
      browser_profile_export: "Copy one saved managed browser profile directory to a local export path so it can be archived or moved to another host",
      ...
      browser_network_export: "Export the managed-browser network capture log to a local JSON file for later inspection or attachment",
      ...
      browser_errors_export: "Export the managed-browser error aggregation view to a local JSON file for incident or debugging workflows",
      ...
      system_lock: "Lock the current host session through the operating system",
      system_sleep: "Suspend the host operating system into sleep mode",
      ...
      desktop_mouse_position: "Read the current desktop pointer coordinates",
      ...
      desktop_screen_info: "Read monitor bounds, working areas, and virtual desktop geometry",
      desktop_snapshot: "Collect mouse position, screen info, foreground window, and visible windows",
